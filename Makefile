...
run: $(BIN_DIR)/cpp_test
	...
	ENV_PROFILE_FILE_PATH=stats_cc.txt ENV_PROFILE_FREQUENCY=1 ENV_NAMING_TEMPLATE="/tmp/mmap_alloc.XXXXXXXX" ENV_MMAP_ALLOCATOR_MIN_BSIZE=100663296 ENV_MMAP_HEAP_SIZE=68719476736 $(BIN_DIR)/c_test
